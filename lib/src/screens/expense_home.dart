...
class _ExpenseHomeState extends State<ExpenseHome> {
  ...
  Future<void> _handleRestore() async {
    ...
    final confirm = await AppDialogs.showConfirmation(
      ...
      message: 'This will replace all your current data with the backup. This action cannot be undone.',
      confirmText: 'Restore',
      cancelText: 'Cancel',
      isDangerous: true,
    );
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: MonthProgress(totalBudget: totalBudget, totalSpent: totalSpent),
                    ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSectionHeader('Category Wise Expenses', Icons.pie_chart_outline),
                ...
                Container(
                  ...
                  padding: const EdgeInsets.symmetric(vertical: AppDimens.paddingM, horizontal: AppDimens.paddingL),
                  decoration: BoxDecoration(
                    gradient: AppColors.primaryGradient,
                  ...
                  child: ExpenseHistory(
                    ...
                    onRemove: (id) async {
                      ...
                      if (confirm) {
                        ...
                        if (mounted) {
                          SnackbarService.showSuccess(context, 'Expense deleted');
                        }
                      }
                    },
                  ),
  ...
  Widget _buildSectionHeader(String title, IconData icon) {
    return Container(
      padding: const EdgeInsets.symmetric(vertical: AppDimens.paddingS, horizontal: AppDimens.paddingM),
      decoration: BoxDecoration(
              ...
              children: [
                ...
                _buildDrawerItem(
                  ...
                  onTap: () {
                    Navigator.of(context).pop();
                    Navigator.of(context).push(
                      FadePageRoute(page: SummaryPage(expenses: _expenses, budgets: _budgets)),
                    );
                  },
                ),
                _buildDrawerItem(
                  ...
                  onTap: () {
                    Navigator.of(context).pop();
                    Navigator.of(context).push(
                      FadePageRoute(page: ExpenseHistoryPage(expenses: _expenses)),
                    );
                  },
                ),
                ...
                _buildDrawerItem(
                  icon: _driveBackup.isSignedIn() ? Icons.logout : Icons.login,
                  title: _driveBackup.isSignedIn() ? 'Sign Out' : 'Sign In with Google',
                  subtitle: _driveBackup.isSignedIn() 
                      ? _driveBackup.getCurrentUserEmail() ?? 'Connected'
                      : 'Connect to backup your data',
                  onTap: _isBackupInProgress ? null : () {
                    Navigator.of(context).pop();
                    _handleGoogleSignIn();
                  },
